define("textarea", [ "$", "selection", "./autocomplete-debug", "overlay", "position", "iframe-shim", "widget", "base", "class", "events", "templatable", "handlebars", "./data-source-debug", "./filter-debug", "./input-debug", "./autocomplete-debug.handlebars" ], function(require, exports, module) {
    var $ = require("$");
...
define("autocomplete", [ "$", "overlay", "position", "iframe-shim", "widget", "base", "class", "events", "templatable", "handlebars", "./data-source-debug", "./filter-debug", "./input-debug", "./autocomplete-debug.handlebars" ], function(require, exports, module) {
    var $ = require("$");
...
define("autocomplete/1.3.0/data-source-debug", [ "base", "class", "events", "$" ], function(require, exports, module) {
...
define("autocomplete/1.3.0/filter-debug", [ "$" ], function(require, exports, module) {
    var $ = require("$");
    var Filter = {
...
define("autocomplete/1.3.0/input-debug", [ "$", "base", "class", "events" ], function(require, exports, module) {
    var $ = require("$");
    var Base = require("base");
...
define("autocomplete/1.3.0/autocomplete-debug.handlebars", [ "handlebars-runtime" ], function(require, exports, module) {
