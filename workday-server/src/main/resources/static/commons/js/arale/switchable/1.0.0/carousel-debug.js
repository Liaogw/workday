define("carousel", [ "./switchable-debug", "$", "widget", "base", "class", "events", "./plugins/effects-debug", "easing", "./plugins/autoplay-debug", "./plugins/circular-debug", "./const-debug" ], function(require, exports, module) {
...
define("arale/switchable/1.0.0/switchable-debug", [ "$", "widget", "base", "class", "events", "./plugins/effects-debug", "easing", "./plugins/autoplay-debug", "./plugins/circular-debug", "./const-debug" ], function(require, exports, module) {
    // Switchable
    // -----------
...
define("arale/switchable/1.0.0/plugins/effects-debug", [ "$", "easing" ], function(require, exports, module) {
    var $ = require("$");
    require("easing");
    var SCROLLX = "scrollx";
    var SCROLLY = "scrolly";
...
define("arale/switchable/1.0.0/plugins/autoplay-debug", [ "$" ], function(require, exports, module) {
    var $ = require("$");
    var win = $(window);
    // 自动播放插件
    module.exports = {
...
define("arale/switchable/1.0.0/plugins/circular-debug", [ "$", "./plugins/effects-debug", "easing" ], function(require, exports, module) {
    var $ = require("$");
    var SCROLLX = "scrollx";
    var SCROLLY = "scrolly";
    var Effects = require("./plugins/effects-debug").Effects;
    // 无缝循环滚动插件
    module.exports = {
        // 仅在开启滚动效果时需要
        isNeeded: function() {
