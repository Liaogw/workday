define("tip",["./basic-tip-debug","$","./tip-debug.css"],function(require, exports, module){
	var $ = require("$"),
		BasicTip = require('./basic-tip-debug');
...
define("arale/tip/1.2.0/basic-tip-debug", ["popup"], function(require, exports, module) {
