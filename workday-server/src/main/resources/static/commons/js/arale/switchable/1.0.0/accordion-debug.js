define("accordion", [ "./switchable-debug", "$", "widget", "base", "class", "events", "./effects-debug", "easing", "./autoplay-debug", "./circular-debug", "./const-debug" ], function(require, exports, module) {
...
define("arale/switchable/1.0.0/switchable-debug", [ "$", "widget", "base", "class", "events", "./effects-debug", "easing", "./autoplay-debug", "./circular-debug", "./const-debug" ], function(require, exports, module) {
    // Switchable
    // -----------
    ...
    var Effects = require("./effects-debug");
    var Autoplay = require("./autoplay-debug");
    var Circular = require("./circular-debug");
...
define("arale/switchable/1.0.0/effects-debug", [ "$", "easing" ], function(require, exports, module) {
    var $ = require("$");
    require("easing");
    var SCROLLX = "scrollx";
    var SCROLLY = "scrolly";
...
define("arale/switchable/1.0.0/autoplay-debug", [ "$" ], function(require, exports, module) {
    var $ = require("$");
    var win = $(window);
    // 自动播放插件
    module.exports = {
...
define("arale/switchable/1.0.0/circular-debug", [ "$", "./effects-debug", "easing" ], function(require, exports, module) {
    var $ = require("$");
    var SCROLLX = "scrollx";
    var SCROLLY = "scrolly";
