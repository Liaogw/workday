define("validator", [ "./core-debug", "$", "./async-debug", "widget", "base", "class", "events", "./utils-debug", "./rule-debug", "./item-debug" ], function(require, exports, module) {
    ...
    var Validator = Core.extend({
        ...
        attrs: {
            ...
            showMessage: function(message, element) {
                message = '<i class="ui-tiptext-icon iconfont">&#x3435;</i>\
...
define("arale/validator/0.9.5/core-debug", [ "$", "./async-debug", "widget", "base", "class", "events", "./utils-debug", "./rule-debug", "./item-debug" ], function(require, exports, module) {
    var $ = require("$"), 
    ...
    var Core = Widget.extend({
        ...
        Statics: $.extend({
            helper: utils.helper
        }, require("arale/validator/0.9.5/rule-debug"), {
...
define("arale/validator/0.9.5/async-debug", [], function(require, exports, module) {
    var async = {};
...
define("arale/validator/0.9.5/utils-debug", [ "$", "./rule-debug" ], function(require, exports, module) {
    var $ = require("$"), 
...
define("arale/validator/0.9.5/rule-debug", [ "$" ], function(require, exports, module) {
...
define("arale/validator/0.9.5/item-debug", [ "$", "./utils-debug", "./rule-debug", "widget", "base", "class", "events", "./async-debug" ], function(require, exports, module) {
    var $ = require("$"), 
        utils = require("./utils-debug"), 
        Widget = require("widget"), 
        async = require("./async-debug"), 
