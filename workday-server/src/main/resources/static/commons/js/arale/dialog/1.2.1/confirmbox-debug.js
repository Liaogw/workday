define("confirmbox", [ "$", "./dialog-debug", "overlay", "position", "iframe-shim", "widget", "base", "class", "events", "mask", "templatable", "handlebars", "./dialog-debug.handlebars", "./confirmbox-debug.handlebars" ], function(require, exports, module) {
...
define("arale/dialog/1.2.1/dialog-debug", [ "$", "overlay", "position", "iframe-shim", "widget", "base", "class", "events", "mask", "templatable", "handlebars","./dialog-debug.handlebars" ], function(require, exports, module) {
    var $ = require("$"), 
...
define("arale/dialog/1.2.1/confirmbox-debug.handlebars", [ "handlebars-runtime" ], function(require, exports, module) {
    var Handlebars = require("handlebars-runtime");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
