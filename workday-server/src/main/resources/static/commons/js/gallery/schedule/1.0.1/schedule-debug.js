define("schedule", ["$","./i18n-debug","./schedule-debug.css","./lunar-debug","inno/dialog/1.0.0/confirmbox-debug"], function(require, exports, module) {
    var $=require("$");
    require("./schedule-debug.css");
    var i18n = require("./i18n-debug");
    var Dialog =require("inno/dialog/1.0.0/confirmbox-debug");
...
//                strhtml +="     <li><i style=\"background:#4ac500\"></i><span>预计靠港时间</span></li>";
                ...
                strhtml +="     <li class=\"selected\"><span>日协调会</span></li>";
