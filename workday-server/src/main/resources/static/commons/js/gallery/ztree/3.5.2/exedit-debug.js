define("gallery/ztree/3.5.2/exedit-debug", [ "$" ], function(require, exports, module) {
    var jQuery = require("$");
    /*
            ...
            showIfameMask: function(setting, showSign) {
                ...
                if (showSign) {
                    ...
                    for (var i = 0, l = iframeList.length; i < l; i++) {
                        var obj = iframeList.get(i), r = tools.getAbs(obj), dragMask = $("<div id='zTreeMask_" + i + "' class='zTreeMask' style='top:" + r[1] + "px; left:" + r[0] + "px; width:" + obj.offsetWidth + "px; height:" + obj.offsetHeight + "px;'></div>");
