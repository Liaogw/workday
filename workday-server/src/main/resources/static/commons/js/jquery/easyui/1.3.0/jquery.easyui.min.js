define("easyui",["$","./easyui.css"],function(require, exports, module){
/**
 * jQuery EasyUI 1.3
 * 
...
(function($){
	function _1(_2){
		...
		var _4=_3.options;
		var bb=_3.bb={};
		var _5={first:{iconCls:"pagination-first",
					   handler:function(){
						if(_4.pageNumber>1){
							_d(_2,1);
						}
				...
				refresh:{iconCls:"pagination-load",
					  handler:function(){
		...
		function _9(_a){
			...
			a.wrap("<td></td>");
			a.unbind(".pagination").bind("click.pagination",_5[_a].handler);
			return a;
		};
		if(_4.showPageList){
		...
		if(_4.buttons){
			...
			for(var i=0;i<_4.buttons.length;i++){
				...
				if(_c=="-"){
					...
					$("<a href=\"javascript:void(0)\" ></a>").appendTo(td).bind("click",eval(_c.handler||function(){}));
				}
			}
		}
	...
	function _11(_12,_13){
		...
		bb.prev.addClass("iconfont-basic prev");
		bb.prev.html("&#xe69a;");
		bb.first.addClass("iconfont-basic first");
		bb.first.html("&#xe686;");
		bb.next.addClass("iconfont-basic next");
		bb.next.html("&#xe688;");
		bb.last.addClass("iconfont-basic last");
		bb.last.html("&#xe687;");
	...
	function _17(_18,_19){
		...
		if(_1a.showRefresh){
			if(_1a.loading){
				bb.refresh.addClass("iconfont-basic refresh");
				bb.refresh.html("&#xf004b;")
			}else{
				bb.refresh.addClass("iconfont-basic refresh-load");
				bb.refresh.html("&#xf004b;")
			}
		}
	};
...
(function($){
	...
	var td=$("<td rowspan=\""+_3f.frozenColumns.length+"\"><div class=\"datagrid-header-rownumber\">序号</div></td>");
	if($("tr",t).length==0){
